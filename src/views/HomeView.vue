  ...
  <div>
        ...
        <div class="col-lg-4 text-center bg-secondary py-3">
          <div class="d-inline-flex align-items-center justify-content-center">
            ...
            <div class="text-start">
              ...
              <span>amacakesart@gmail.com</span>
            </div>
          </div>
        </div>
          ...
          <div class="d-inline-flex align-items-center justify-content-center">
            <a href="#" class="navbar-brand">
              <h1 class="m-0 text-uppercase text-white">
                <i class="fa fa-birthday-cake fs-1 text-dark me-3"></i>AMA CAKES ARTS
              </h1>
            </a>
          </div>
        </div>
    ...
    >
      <a href="#" class="navbar-brand d-block d-lg-none">
        <h1 class="m-0 text-uppercase text-white" style="color: white;">
          <i class="fa fa-birthday-cake fs-1 text-primary me-3"></i>Ama Cakes Arts
        </h1>
      </a>
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto mx-lg-auto py-0">
          ...
          <a href="/chefs" class="nav-item nav-link">Master Chefs</a>
      ...
      <div class="container py-5">
        <div class="row justify-content-start">
          <div class="col-lg-8 text-center text-lg-start">
            <h1 class="font-secondary text-primary mb-4">Amani Cedric</h1>
            <h1 class="display-1 text-uppercase text-white mb-4">AMA CAKES ARTS</h1>
            <h1 class="text-uppercase text-white">The Best Cake In Kigali</h1>
            <div
    ...
    <div class="container-fluid pt-5">
      <div class="container">
        ...
        >
          ...
          <h1 class="display-4 text-uppercase">Welcome To Ama Cakes</h1>
        </div>
        <div class="row gx-5">
            ...
            <div class="row gx-5">
              <div class="col-lg-4 col-md-12 pt-5 mb-5">
                ...
                <div class="d-flex mb-2">
                  ...
                  <p class="mb-0">Muhima, Near Hospital</p>
                </div>
                <div class="d-flex mb-2">
                  <i class="bi bi-envelope-open text-primary me-2"></i>
                  <p class="mb-0">amacakesart@gmail.com</p>
                </div>
                <div class="d-flex mb-2">
                  <i class="bi bi-telephone text-primary me-2"></i>
                  <p class="mb-0">+250 784 315 934</p>
                </div>
    ...
    >
      <div class="container text-center">
        <p class="mb-0">
          &copy;
          <a class="text-white border-bottom" href="#">Ama Cakes Arts</a>. All
          Rights Reserved.
        </p>
      </div>
    </div>
